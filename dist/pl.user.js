...
const libpaged = 'https://naeembolchhi.github.io/pocket-library/lib/paged.js',
      ...
      getIcon = {
          ...
          "plus": `<svg class="pl-plus" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 96 96" fill="currentColor"><path d="M0 0h96v96H0z" fill="none"/><path d="M82.63 43.54H96v8.92H82.63v13.37h-8.92V52.46H60.34v-8.92h13.37V30.17h8.92v13.37ZM15.69 62.5H39.7l5.29 15.22h10.28L32.92 18.28H22.34L0 77.72h10.28l5.41-15.22Zm9.39-26.27 2.32-6.9h.48l2.32 6.9 6.3 17.71H18.79l6.3-17.71Z"/></svg>`,
          "minus": `<svg class="pl-minus" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 96 96" fill="currentColor"><path d="M0 0h96v96H0z" fill="none"/><path d="M96 43.54v8.92H60.33v-8.92H96ZM15.69 62.5H39.7l5.29 15.22h10.28L32.92 18.28H22.34L0 77.72h10.28l5.41-15.22Zm9.39-26.27 2.32-6.9h.48l2.32 6.9 6.3 17.71H18.79l6.3-17.71Z"/></svg>`,
          ...
          "linespacing": `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 96 96" fill="currentColor"><path d="M0 0h96v96H0V0Z" fill="none"/><path d="M21.07 24.47h11.71L16.39 8 0 24.47h11.71v47.06H0L16.39 88l16.39-16.47H21.07V24.47Zm18.73-9.41v9.41H96v-9.41H39.8Zm0 65.88H96v-9.41H39.8v9.41Zm0-28.23H96V43.3H39.8v9.41Z"/></svg>`,
          "pagesize": `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 96 96" fill="currentColor"><path d="M0 0h96v96H0V0Z" fill="none"/><path d="M78.55 48h-8.73v13.09H56.73v8.73h21.82V48ZM26.18 34.91h13.09v-8.73H17.45V48h8.73V34.91ZM87.27 8.73H8.73C3.93 8.73 0 12.65 0 17.45v61.09c0 4.8 3.93 8.73 8.73 8.73h78.55c4.8 0 8.73-3.93 8.73-8.73V17.45c0-4.8-3.93-8.73-8.73-8.73Zm0 69.86H8.73V17.41h78.55v61.18Z"/></svg>`,
          "arrow": `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 96 96" fill="currentColor"><path d="M0 0h96v96H0V0Z" fill="none"/><path d="M66.36 34.36 48 52.68 29.64 34.36 24 40l24 24 24-24-5.64-5.64Z"/></svg>`
      };
...
function getLocal(key) {
    ...
    try {
        ...
        localStorage.removeItem('pl_lvar');
