...
#pocketlibrary .pl-settings, #pocketlibrary .pl-prepare {
  padding: calc(0.15 * var(--_rem));
  background: var(--_bg-main);
  border-radius: calc(2.3 * var(--_rem));
  box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;
}
#pocketlibrary .pl-settings svg, #pocketlibrary .pl-prepare svg {
  height: calc(1 * var(--_rem));
  width: calc(1 * var(--_rem));
}
#pocketlibrary .pl-settings cloak, #pocketlibrary .pl-prepare cloak {
  display: flex;
  align-items: center;
  justify-content: center;
  gap: calc(0.5 * var(--_rem));
...
#pocketlibrary .pl-settings:hover cloak, #pocketlibrary .pl-settings:focus cloak, #pocketlibrary .pl-prepare:hover cloak, #pocketlibrary .pl-prepare:focus cloak {
  color: var(--_accent-main);
  background: var(--_bg-hover);
}
#pocketlibrary .pl-settings:active a, #pocketlibrary .pl-settings:active button, #pocketlibrary .pl-prepare:active a, #pocketlibrary .pl-prepare:active button {
